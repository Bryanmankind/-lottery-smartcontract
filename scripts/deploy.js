const { ethers } = require("hardhat");
    ...
    const main = async () => {
      ...
      console.log("balance of lottery before pick  :", getBalnceTxn1);
      ...
      // call the randomNumber of the contract 

      const getRanNumberTxn =  await LotteryContract.getRanNumber();
      console.log("Random Number :", getRanNumberTxn);
      ...
      console.log("balance of lottery contract after pick  :", getBalnceTxn2);
